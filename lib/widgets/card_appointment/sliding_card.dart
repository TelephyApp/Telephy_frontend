library sliding_card;

import 'package:flutter/material.dart';

///This Class is used to control the opening and
///closing of the card
class SlidingCardController {
  ///This is to slide the card down
  late Function expandCard;

  ///This is to slide the card up
  late Function collapseCard;

  ///Whether the card is collapsed or not
  late bool isCardSeparated;
}
...
class SlidingCard extends StatefulWidget {
  ...
  ///height of the back card,It
  ///cannot be greater than the height of the front card
...
class _SlidingCardState extends State<SlidingCard>
  ...
  late Tween<double> separatedValue;
